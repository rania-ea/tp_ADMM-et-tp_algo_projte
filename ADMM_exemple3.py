# algorithme ADMM   
#### EXEMPLE 3 : taux de saticfaction ####
#puisqu’il y a plusieurs variables, on ne peut pas tracer une "droite", mais on peut comparer prédiction et réalité
...
# imoprtation 
d2 = np.loadtxt('C:/Users/rania/OneDrive/Documents/SatisfactionRate30x6.dat.txt') # matrice de donner dont la derriniere ligne est la matrice b et le rest est A
n2 = len(d2)
