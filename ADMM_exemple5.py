# algorithme ADMM   
#### EXEMPLE  5 : LAV(least absolute value)  ####
...
A_data = np.loadtxt('C:/Users/rania/Downloads/lav_A_1000x100.dat').reshape(1000, 100)
b = np.loadtxt('C:/Users/rania/Downloads/lav_b_1000x1.dat').reshape(1000, 1)

# Ajout d'une colonne de 1 pour le biais
A = np.concatenate([np.ones((1000, 1)), A_data], axis=1)
